...
<HTML>
      ...
      <header>
        ...
        <section>
          ...
          <?php if (isset($_POST['submit'])){ ?>
              ...
              <ul>
                  <table id="penguji" border="0">
                  <tr>
                    <Td></td>
                    <td>REKAPITULASI HASIL EVALUASI PENGUJI</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    <td></td>
                    <td>Nama Penguji : <?php echo $_POST['namapengajar']?></td>
                    </tr>
                    <tr>
                    <td></td>
 ...
 if(mysqli_num_rows($query)>0) {?>
                  ...
                  <button onclick="exportTableToExcel('penguji', 'penguji')">Download</button> 
                  <?php } ?>             
          </article>
       </section>  
        <footer>
