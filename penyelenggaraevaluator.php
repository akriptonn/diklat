...
<HTML>
  <head>
    ...
    <title>Rekapitulasi Hasil Evaluasi Penyelenggara oleh Evalutor</title>
    <meta charset="utf-8">
  ...
  <body>
      <header>
        ...
        <section>
            <nav>
            <form action="penyelenggaraevaluator.php" method="post">
          ...
          <?php if (isset($_POST['submit'])){ ?>
              ...
              <table id="pengampu" border="0">
                    ...
                    <?php }?>
                    <?php } $sq = "SELECT averages FROM reratanilaipenyelenggaraev where ";
                        $sq = $sq . " NamaDiklat = " . "'" . $_POST['program'] ."'";
                        $sq = $sq . " and Tempat = " . "'" . $_POST['tempat'] ."'";
                        $sq = $sq . " and Durasi = " . "'" . $_POST['durasi'] ."'";
                        $sq = $sq . " ;";
                    ...
                    <td></td>
                        <td><?php
                        $sq = "SELECT Saran from saranpenyelenggaraev,reratanilaipenyelenggaraev where transaksi = reratanilaipenyelenggaraev.prime and ";
                        $sq = $sq . " NamaDiklat = " . "'" . $_POST['program'] ."'";
                        $sq = $sq . " and Tempat = " . "'" . $_POST['tempat'] ."'";
                        $sq = $sq . " and Durasi = " . "'" . $_POST['durasi'] ."'";
                        $sq = $sq . " ;";
