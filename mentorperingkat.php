...
$rans = 0;
$query = mysqli_query($koneksi, "SELECT NamaMentor as NamaCoach,AVG(averages) as average FROM reratanilaimentor GROUP BY NamaMentor ORDER BY average DESC");
      ...
      <header>
        ...
        <section>
          <article>
              <ul>
                <form action="">
                  <table id="mentorperingkat" border="0">
                  <tr>
                  <td></td>
                  ...
                  <button onclick="exportTableToExcel('mentorperingkat', 'mentor peringkat')">Download</button>
          </article>
       </section>
      </form>    
        <footer>
