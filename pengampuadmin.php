...
<HTML>
  <head>
    ...
    <title>Rekapitulasi Hasil Evaluasi Widyaiswara/WILB</title>
    <meta charset="utf-8">
  ...
  <body>
      <header>
        ...
        <section>
            <nav>
              <h2 style="color: rgb(34, 80, 90)">Rekapitulasi Hasil Evaluasi Widyaiswara/WILB</h2>
              <p><img src="kemnakerri.jpg" width="200px"></p><br>
              <p style="color: rgb(34, 80, 90)">Diklat : WAS KK Spesialis Pesawat Tenaga dan Produksi</p>
              <p style="color: rgb(34, 80, 90)">Mata Diklat : Pengetahuan dan Pengujian Bahan Logam</p>
              <p style="color: rgb(34, 80, 90)">Nama Widyaiswara/WILB : Ir, Sumaryanto</p>
              <p style="color: rgb(34, 80, 90)">Tanggal Mengajar : Selasa/ 31 Juli 2018</p>
              <p style="color: rgb(34, 80, 90)">Waktu: 08.00-22.00 WIB (10 JP)</p>
            </nav>
          <article>
              <ul>
                  <table border="1">
